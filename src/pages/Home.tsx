      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8">
              Connect with skilled people and grow together
            </p>
            <Link
              to="/signup"
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">Join or create teams to work on projects together</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="text-blue-600 mb-4">
              <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p className="text-gray-600">Learn and grow with peers who share your interests</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="text-blue-600 mb-4">
              <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p className="text-gray-600">Organize and track your team's progress effectively</p>
          </div>
        </div>
      </div>

      {/* Footer */}
      <footer className="bg-white shadow-md mt-24">
